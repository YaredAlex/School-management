...
import 'package:school_managment/features/time_table/view/no_time_table.dart';
...
class TimeTableScreen extends StatelessWidget {
                ...
                () => Container(
                  ...
                  child: RefreshIndicator(
                    ...
                    child: controller.isLoading.value
                        ? _buildLoadingTimeTable(context)
  ...
  Widget _buildLoadingTimeTable(BuildContext context) {
  ...
  Widget _buildTimeTable(BuildContext context) {
    return controller.weeklyTimeTable.isEmpty
        ? NoTimeTableCard(
        ...
        : ListView(
            ...
            children: controller.weeklyTimeTable.entries.map((entry) {
              return _buildDayExpansionTile(
                  context: context, day: entry.key, entries: entry.value);
            }).toList(),
          );
  }
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            ...
            if (entry.instructor != null) Text('Teacher: ${entry.instructor}'),
          ],
        ),
